...
(meditations
  ...
  (= "Rich Hickey aka The Clojurer aka Go Time aka Lambda Guru"
     (let [[first-name last-name & aliases]
       ...
       (clojure.string/join " aka " [(str first-name " " last-name) (clojure.string/join " aka " aliases ) ])))
  ...
  (= "Test Testerson, 123 Test Lane, Testerville, TX"
     ((fn [[a b] {:keys [street-address city state]}]
        (str a " " b ", " (clojure.string/join ", " [street-address city state]))) ["Test" "Testerson"] test-address)))
